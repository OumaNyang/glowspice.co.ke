              ...
              return (
                <div key={mainCat.id} className="p-5 bg-white hover:bg-orange-50/30 transition-colors">
                  <div className="flex items-center gap-5 mb-5">
                    <div className="w-16 h-16 rounded-2xl border-2 border-[var(--border)] overflow-hidden flex-shrink-0 relative shadow-sm">
                      {mainCat.image ? (
                        <Image src={mainCat.image} alt={mainCat.name} fill className="object-cover" />
                      ) : (
                  ...
                  {isCardExpanded && (
                    <div className="mt-5 pt-5 border-t border-[var(--border)] space-y-6 animate-in fade-in slide-in-from-top-4 duration-400">
                       ...
                       <div className="p-5 bg-orange-50/50 rounded-2xl border-2 border-orange-100/50">
                         ...
                         <div className="space-y-4 pt-2">
                            ...
                            <div className="space-y-3">
                               {children.map(child => {
                                 ...
                                 return (
                                   <div key={child.id} className={`rounded-2xl border-2 transition-all overflow-hidden ${isSubExpanded ? 'border-blue-400 bg-blue-50/30 ring-4 ring-blue-100' : 'border-[var(--border)] bg-white'}`}>
                                      <div 
                   ...
                   <button 
                    ...
                    className="mt-6 w-full flex items-center justify-center gap-3 py-3.5 text-[10px] font-black uppercase tracking-[0.25em] text-[var(--spice)] bg-[var(--cream)] hover:bg-[var(--cream-dark)] rounded-2xl border-2 border-[var(--border)] transition-all shadow-sm active:scale-95"
                  >
