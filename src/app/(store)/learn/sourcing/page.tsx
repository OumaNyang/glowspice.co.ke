    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="bg-[var(--cream)] rounded-2xl shadow-sm border border-[var(--border)] p-12 md:p-20 text-center relative overflow-hidden grain">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-heading font-black text-[var(--bark)] mb-6 text-gradient">Ethical Sourcing</h1>
          <p className="text-xl text-[var(--gray-700)] max-w-2xl mx-auto leading-relaxed">
            We believe in transparency from farm to table. We are preparing our interactive sourcing map.
            <br /><br />
            <span className="font-semibold text-[var(--spice)]">Sourcing stories coming soon!</span>
          </p>
        </div>
      </div>
    </div>
